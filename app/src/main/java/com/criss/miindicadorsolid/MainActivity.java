...
public class MainActivity extends AppCompatActivity implements RequestInterfaceApi {
    ...
    public void consultarIndicador(View v) {
        try {
            new IndicadorEconomicoHandler(tipoIndicador.getText().toString(),
                    fechaIndicador.getText().toString()).getIndicadorEconomico((RequestInterfaceApi) this);
        } catch (Exception e) {
            Log.e(TAG, "Error: ", e);
        }
    }
